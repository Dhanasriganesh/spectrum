...
export const sendContactFormEmail = async (data, attachmentPath) => {
  try {
...
// Send both emails (admin notification + customer confirmation)
export const sendContactFormEmails = async (data, attachmentPath) => {
  const adminSent = await sendContactFormEmail(data, attachmentPath);
  const customerSent = await sendContactConfirmationEmail(data);
